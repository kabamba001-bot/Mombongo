...
function computeStoreAlerts(storeData){
  ...
  // La clé inclut le nombre de jours restants : comme ce nombre change chaque
  // jour, l'alerte est vue comme "nouvelle" à chaque fois par send-new-alerts.js
  // (au lieu de ne notifier qu'une seule fois au premier jour du compte à rebours).
