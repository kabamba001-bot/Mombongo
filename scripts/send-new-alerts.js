...
async function run(){
  ...
  for(const userDoc of usersSnap.docs){
    ...
    for(const store of stores){
      ...
      // La clé d'une dette inclut le nombre de jours restants (ex: "due:xyz:2"),
      // qui change chaque jour — donc chaque jour du compte à rebours (et chaque
      // jour de retard une fois l'échéance dépassée) est traité comme une
      // nouvelle alerte à part entière, comme demandé.
